...
$conf["tm_subscriptions_user_cta_chapter_pages"] = true; // show call to action on chapter pages
$conf["tm_subscriptions_user_cta_event_pages"] = true; // minimum call to action on event pages
