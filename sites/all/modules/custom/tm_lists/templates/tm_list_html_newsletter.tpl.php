  ...
  <style type="text/css">
    @media screen {
      @font-face {
        ...
        font-style: normal;
        font-weight: 400;
        src: local('Lato Regular'), local('Lato-Regular'), url('https://fonts.gstatic.com/s/lato/v16/S6uyw4BMUTPHjxAwWA.woff') format('woff'), url('https://fonts.gstatic.com/s/lato/v16/S6uyw4BMUTPHjxAwXg.woff2') format('woff2');
      }
      @font-face {
        font-family: 'Lato';
        font-style: normal;
        font-weight: 700;
        src: local('Lato Bold'), local('Lato-Bold'), url('https://fonts.gstatic.com/s/lato/v16/S6u9w4BMUTPHh6UVSwaPHw.woff') format('woff'), url('https://fonts.gstatic.com/s/lato/v16/S6u9w4BMUTPHh6UVSwaPGQ.woff2') format('woff2');
      }
    }
...
<body style="width: 100% !important; margin: 0; padding: 0; mso-line-height-rule: exactly; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; background-color: #f4f4f4" class="">
  <span style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">__LIST_PREVIEW_TEXT__</span>
                ...
                <td align="left" valign="top" style="padding: 0 10px;">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation" style="box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.1)">
                    <tbody>
                      <tr>
                        <td valign="top">
                          <!-- BEGIN MODULE: Content 8 -->
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-sm-p-25-10-30 pc-xs-p-15-0-20" style="padding: 15px 20px 35px; background-color: #ffffff" valign="top" bgcolor="#ffffff">
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                    <tbody>
                                      <tr>
                                        <td height="20" style="height: __TOP_PADDING_PX__; font-size: 1px; line-height: 1px;">&nbsp;</td>
                                      </tr>
                                      <tr>
                                        <td valign="top">
                                          <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                            <tbody>
                                              __LIST_COVER_IMAGE__
                                              <tr>
                          ...
                          <!-- END MODULE: Content 8 -->
                          <!-- BEGIN MODULE: Content 11 -->
                          <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                            <tbody>
                              <tr>
                                <td class="pc-sm-p-25-10-15 pc-xs-p-15-0-5" valign="top" bgcolor="#ffffff" style="padding: 10px 20px 20px; background-color: #ffffff">
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                    <tbody>
                                      <tr>
                              ...
                              <tr>
                                <td class="pc-sm-p-35-30 pc-xs-p-25-20" style="padding: 40px 30px 32px; background-color: #ffffff;" valign="top" bgcolor="#ffffff">
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                    <tbody>
                                      <tr>
                                        <td class="pc-xs-fs-30 pc-xs-lh-42 pc-fb-font" style="font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 36px; font-weight: 900; line-height: 46px; letter-spacing: -0.6px; color: #151515; text-align: center;" valign="top"><a href="__LIST_URL__">View the entire list.</a></td>
                                      </tr>
                                      <tr>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td class="pc-fb-font" style="font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 300; line-height: 28px; color: #9B9B9B; text-align: center;" valign="top">See who else is featured on __SITE_NAME__.</td>
                                      </tr>
                                      <tr>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td style="padding: 13px 17px; border-radius: 8px; background-color: #427BDC;" bgcolor="#427BDC" valign="top" align="center">
                                                            <a class="pc-fb-font" href="https://www.facebook.com/sharer/sharer.php?u=__ENCODED_LIST_URL__" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;"><img src="__FACEBOOK_ICON_URL__" alt="" style="border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; vertical-align: middle; margin-top: -2px;" width="15">&nbsp;<span>Share on Facebook</span></a>
                                                          </td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          <td style="padding: 13px 17px; border-radius: 8px; background-color: #36B0FF;" bgcolor="#36B0FF" valign="top" align="center">
                                                            <a class="pc-fb-font" href="https://twitter.com/share?url=__ENCODED_LIST_URL__" style="line-height: 1.5; text-decoration: none; word-break: break-word; font-weight: 500; display: block; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff;"><img src="__TWITTER_ICON_URL__" alt="" style="border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; vertical-align: middle; margin-top: -2px;" width="15">&nbsp;<span>Share on Twitter</span></a>
                                                          </td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
                              ...
                              <tr>
                                <td class="pc-sm-p-35-30 pc-xs-p-25-20" valign="top" bgcolor="#ffffff" style="padding: 40px; background-color: #ffffff;">
                                  <table border="0" cellpadding="0" cellspacing="0" style="text-align: center;" width="100%" align="center" role="presentation">
                                    <tbody>
                                      <tr>
                                        <td class="pc-fb-font" valign="top" style="line-height: 28px; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 300; letter-spacing: -0.2px; color: #9B9B9B;">
                                          __LIST_OUTRO__
                                        </td>
                                      </tr>
                                      <tr>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td class="pc-fb-font" valign="top" style="text-align: center; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 500; line-height: 21px; letter-spacing: -0.1px; color: #1B1B1B;">
                                          __LIST_CREATORS__
                                        </td>
                                      </tr>
                                      <tr>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td class="pc-fb-font" valign="top" style="text-align: center; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 300; line-height: 20px; letter-spacing: -0.2px; color: #9B9B9B;">
                                        	__CREATED_BY__
                                        </td>
                                      </tr>
                                    </tbody>
