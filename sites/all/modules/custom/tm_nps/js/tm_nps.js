...
(function ($, Drupal, window, document, undefined) {jQuery(document).ready(function(){
  ...
  jq_net_promoter_score = function(site_name) {
    ...
    message = message + "<td style='width: 9%' align='center'><span class='tm_nps'><input onChange='updateFeedbackLabel()' type='radio' class='tm_nps' name='tm_nps' id='tm_nps_10' value='10'><br><label for='tm_nps_10'>10</label></span></td>";
	  message = message + "</tr>";
	  message = message + "<tr><td colspan='6' style='width: 50%;'><i>&nbsp;&nbsp;Unlikely</i></td><td colspan='5' style='width: 50%;' align='right'><i>Very likely&nbsp;&nbsp;</i></td></tr>";
    ...
    $.prompt(message, { 
      ...
      submit: function(e,v,m,f){
        if (v == true) {
          ...
          var nps_score = $('input[name=tm_nps]:checked').val();
          window.location = '/feedback/submit?score=' + nps_score + '&comment=' + $("#form_nps_comment").val();
        }
      }
    });
