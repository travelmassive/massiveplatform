  ...
  jq_confirm_approve_member = function(uid, community_values_url) {
    ...
    $.prompt({
      state0: {
        ...
        html: 'Guidelines for approval:<li>Account is a real person</li><li>Profile is not a company or brand</li><li>Profile picture is not a brand logo</li><li>Links provided are personal and not just company</li><li>Profile meets our <a target="_blank" href="' + community_values_url + '">community values</a></li>',
