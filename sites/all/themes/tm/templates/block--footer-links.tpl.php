<section class="foot">
	<h2>More Massive</h2>
		<ul class="links">
		<li class="menu first"><a href="https://travelmassive.com/blog/about-travel-massive/">About</a></li>
		<li class="menu-770"><a href="/contact" class="active-trail active">Contact</a></li>
		<li class="menu-770"><a href="/blog/start-a-chapter">Start A Chapter</a></li>
